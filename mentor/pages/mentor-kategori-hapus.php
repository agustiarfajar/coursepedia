        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              ?>
              <div class="card-body">
                <form action="mentor-kategori-aksihapus.php" method="post">
                    <div class="form-group">
                        <label for="id_kategori">ID Kategori Materi</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama" maxlength="50" name="nama" value="<?php echo $datakategori["nama"] ?>"autocomplete="off" readonly>
                    </div>
